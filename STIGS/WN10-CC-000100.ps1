<#
.SYNOPSIS
    This PowerShell script sets a registry key to ensure downloading print driver packages over HTTP is prevented.
...
# Ensure downloading print driver packages over HTTP is prevented
...
Ensure-RegistryKeyExists -Path "HKLM:\SOFTWARE\Policies\Microsoft\Windows NT\Printers" -Name "DisableWebPnPDownload" -Value 1
