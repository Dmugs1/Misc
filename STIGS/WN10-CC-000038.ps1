<#
.SYNOPSIS
    This PowerShell script sets a registry key to ensure WDigest Authentication is disabled.
.NOTES
...
Ensure-RegistryKeyExists -Path "HKLM:\SYSTEM\CurrentControlSet\Control\SecurityProviders\WDigest" -Name "UseLogonCredential" -Value 0
